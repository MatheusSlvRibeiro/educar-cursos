            ...
            <div className="grid gap-8 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
                {courses.map((course, index) => (
                    <div key={index} className="bg-white shadow-md rounded-2xl overflow-hidden border border-gray-100 hover:shadow-xl transition-all duration-300">
                        ...
                        <div className="p-5">
                            <span className="text-xs bg-indigo-100 text-indigo-600 font-semibold px-3 py-1 rounded-full inline-block mb-3">
                                {`#${course.tag}`}
                            </span>
                            ...
                            <div className="flex justify-between items-center">
                                {course.disponibilidade === "ativo" ? (
                                    ...
                                    <span className="bg-gray-300 text-gray-600 text-sm font-semibold px-4 py-2 rounded-xl cursor-not-allowed">
                                        Em breve
                                    </span>
                                )}
                            </div>
